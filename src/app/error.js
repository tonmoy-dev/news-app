      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <p className="mb-4 text-lg font-light text-gray-500">
            {/* {error.message},  */}
            Something went wrong! Come back later.</p>
          <Link
            href="/"
            className="px-8 py-3 font-semibold rounded bg-[#ff5555] text-white"
          >
            Try Again
          </Link>
          {/* <button className='px-8 py-3 font-semibold rounded bg-[#ff5555] text-white' onClick={() => reset()}>Try again</button> */}
        </div>
      </div>
    </section>
  );
